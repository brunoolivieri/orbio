...
namespace App\Http\Controllers\v1\Modules\Equipments\Batteries;
...
use App\Http\Requests\v1\Modules\Equipments\Battery\StoreBatteryRequest;
use App\Http\Requests\v1\Modules\Equipments\Battery\UpdateBatteryRequest;
...
class EquipmentModuleBatteryController extends Controller
{
    ...
    public function index(): \Illuminate\Http\Response
    {
        try {
            ...
            return response(new BatteriesPaginationResource($result), 200);
        } catch (\Exception $e) {
