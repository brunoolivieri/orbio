<!-- VERIFY BEFORE SAVE -->
<div id="flight-plan-confirmation-modal" class="relative z-10 transition-all hidden" role="dialog" aria-modal="true">
            ...
            <div class="relative rounded-lg shadow bg-white">
                ...
                <div class="px-6 py-3">
                    <div class="w-full mb-3 flex justify-center">
                        <img id="flight-plan-image" class="h-auto max-w-full" src="" alt="flight plan image">
                    </div>
                    <div class="grid grid-cols-1 gap-x-2 gap-y-2 sm:grid-cols-2">
                        <div>
                            <label for="flight-speed" class="block text-sm font-semibold leading-6 text-gray-900">Velocidade</label>
                            <div class="mt-2.5">
                        ...
                        <div>
                            <label for="flight-distance" class="block text-sm font-semibold leading-6 text-gray-900">Distância</label>
                            <div class="mt-2.5">
                        ...
                        <div>
                            <label for="flight-altitude" class="block text-sm font-semibold leading-6 text-gray-900">Altitude</label>
                            <div class="mt-2.5">
                        ...
                        <div>
                            <label for="flight-time" class="block text-sm font-semibold leading-6 text-gray-900">Tempo</label>
                            <div class="mt-2.5">
                ...
                <div
                    ...
                    <button type="submit" id="btn-save-confirmation-modal"
                        ...
                        <svg id="spin-icon" class="inline hidden w-4 h-4 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
