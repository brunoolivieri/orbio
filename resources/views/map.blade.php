<!DOCTYPE html>
 ...
 <body>
	...
	<div id="top-bar" class="w-screen h-[55px] fixed top-1 flex justify-center">
		<!-- TOP ALERT -->
		<div class="flex items-center rounded bg-red-400 text-white font-bold px-4 py-3" role="alert">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 mr-2 text-white">
				<path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
			  </svg>
			<p id="alert-message">Something happened that you should know about</p>
		  </div>
	</div>
	...
	<div id="bottom-bar" class="w-screen fixed left-0 bottom-0 z-[100] flex justify-center h-18">
		...
		<div class="w-auto h-full flex justify-center rounded-t-sm bg-white">
			<div class="p-5 calculation-box">
				<span id="calculated-area" class="text-stone-800">0 ha</span> -
				<span id="calculated-distance" class="text-stone-800">0 Km</span> -
				<span id="calculated-time" class="text-stone-800">0 s</span>
			</div>
		</div>
		</div>
	</div>
